...
public sealed class RecordDeliveryAttemptCommandHandler
    : IRequestHandler<RecordDeliveryAttemptCommand, Result>
{
    ...
    public async Task<Result> Handle(
        RecordDeliveryAttemptCommand command,
        CancellationToken ct)
    {
        try
        {
            ...
            shipment.RecordDeliveryAttempt(
                command.Result,
