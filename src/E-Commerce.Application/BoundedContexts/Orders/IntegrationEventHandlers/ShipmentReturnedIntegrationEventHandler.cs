...
public sealed class ShipmentReturnedIntegrationEventHandler
    : IIntegrationEventHandler<ShipmentReturnedIntegrationEvent>
{
    private readonly IOrderRepository _orderRepository;
    private readonly IUnitOfWork _unitOfWork;

    public ShipmentReturnedIntegrationEventHandler(
    ...
    public async Task HandleAsync(
        ShipmentReturnedIntegrationEvent integrationEvent,
