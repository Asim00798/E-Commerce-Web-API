using E_Commerce.Domain.BoundedContexts.Administration.Enums;
    ...
    public class Document : BaseEntity
    {
            ...
            string renewedBy)
        {
            ...
            var renewed = new Document
            {
                ...
                AssociatedValue = this.AssociatedValue,
                OwnerId = this.OwnerId,
                OwnerType = this.OwnerType,
                Status = DocumentStatus.PendingVerification,
                Version = this.Version + 1,
                ReplacesDocumentId = this.Id,
            };
        ...
        {
            return OwnerId == ownerId && OwnerType.Equals(ownerType, StringComparison.OrdinalIgnoreCase);
        }
    }
}
