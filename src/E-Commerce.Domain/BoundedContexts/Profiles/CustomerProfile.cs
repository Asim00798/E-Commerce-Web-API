...
using E_Commerce.Domain.BoundedContexts.PersonalData;
using E_Commerce.Domain.BoundedContexts.Reviews;
using E_Commerce.Domain.BoundedContexts.Reviews___Engagement;
using E_Commerce.Domain.SharedKernel.Abstract;

namespace E_Commerce.Domain.BoundedContexts.Profiles
{
